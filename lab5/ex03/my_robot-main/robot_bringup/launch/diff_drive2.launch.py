...
def generate_launch_description():
    ...
    # urdf_path  =  os.path.join(pkg_project_description, 'urdf', 'box_robot.urdf.xacro')
    urdf_path  =  os.path.join(pkg_project_description, 'urdf', 'robot2.urdf.xacro')
    ...
    rviz = Node(
       package='rviz2',
       executable='rviz2',
       arguments=['-d', os.path.join(pkg_project_bringup, 'config', 'diff_drive2.rviz')],
    ...
    bridge = Node(
        ...
        parameters=[{
            ...
            'config_file': os.path.join(pkg_project_bringup, 'config', 'robot_bridge2.yaml'),
